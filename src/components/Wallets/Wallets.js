    ...
    return (
      <section>
        ...
        <div>
          ...
          <img src={`data:image/png;base64,${encodedBase64}`} width="200px" height="200px" />
        </div>
        <div>
